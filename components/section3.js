    ...
    return (
        <div className="item">
            ...
            <div className="info flex justify-center flex-col py-4">
                ...
                <div className="title">
                    <Link legacyBehavior href={"/"}><a className="text-3xl md:text-4xl font-bold text-gray-800 hover:text-gray-600">Your most unhappy customers are your greatest source og learning</a></Link>
                </div>
